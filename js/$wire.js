import {
    ...
    upload,
    uploadMultiple
} from './features/supportFileUploads'
import {
    dispatch,
    dispatchSelf,
    dispatchTo,
...
import {
    generateEntangleFunction
} from '@/features/supportEntangle'
import {
    closestComponent
} from '@/store'
import {
...
wireProperty('$hook', (component) => (name, callback) => {
    let unhook = hook(name, ({
        ...
        if (hookComponent.id === component.id) return callback({
            component: hookComponent,
            ...params
        })
    })
